# AGENTS.md — PartnerProof working notes

Guidance for any coding assistant working in this repo. Tool-agnostic on purpose:
`CLAUDE.md` is a one-line pointer here, and other tools read this file directly. Put new
project guidance here rather than in a tool-specific file.
